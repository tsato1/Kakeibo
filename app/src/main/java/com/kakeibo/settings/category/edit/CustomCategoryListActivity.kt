...
class CustomCategoryListActivity : AppCompatActivity() {
    ...
    private val _customCategoryList = ObservableArrayList<CategoryStatus>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _categoryStatusViewModel.custom.observe(this, {
    ...
    internal inner class ItemClickListener : AdapterView.OnItemClickListener {
        override fun onItemClick(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
            val message = getString(R.string.updated_on_colon) + _customCategoryList[position].savedDate //todo add second
        ...
        when (menuItem.itemId) {
            ...
            MENU_ITEM_ID_DELETE -> {
                categoryStatus?.let {
                    ...
                    dialog.setPositiveButton(R.string.ok) { _, _ ->
                        _categoryStatusViewModel.delete(categoryStatus.id) // todo R.string.msg_category_deleted
                        Toast.makeText(this, R.string.msg_item_successfully_deleted, Toast.LENGTH_LONG).show()
                    }
                    dialog.create()
                    dialog.show()
                }
