...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<ItemStatus>> _hmpChildData;

//todo should be disposable    private TypedArray _trrMipmaps;

    public ExpandableListAdapter(Context context, List<String> dateHeaderList, HashMap<String, List<ItemStatus>> childDataHashMap) {
...
//todo should be disposable        _trrMipmaps = _context.getResources().obtainTypedArray(R.array.category_drawables);
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ItemStatus item = (ItemStatus)baseItem;
