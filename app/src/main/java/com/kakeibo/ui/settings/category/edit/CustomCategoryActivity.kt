...
//
//        /* ads */
//        _kkbAppViewModel.firstEntry.observe(this, {
...
//        val id = intent.getLongExtra("asdf", -1L)
//        val code = intent.getIntExtra("EXTRA_KEY_CATEGORY_CODE", -1)
//        _customCategoryViewModel.allMap.observe(this, {
//            when (code) {
...
//                        _customCategoryViewModel.insert(
//                            CategoryEntity(
//                                null,
//                                _customCategoryViewModel.getCodeForNewCustomCategory(),
...
//                                UtilDate.getTodaysYMD(UtilDate.DATE_FORMAT_DB_KMS),
//                                false
//                            )
//                        )
//                        Toast.makeText(this, R.string.msg_category_created, Toast.LENGTH_LONG)
//                            .show()
//                    }
//                    /* Category edit */
//                    else {
...
//                            )
//                        )
//                        Toast.makeText(this, R.string.msg_category_updated, Toast.LENGTH_LONG)
//                            .show()
//                    }
//                    finish()
//                }
