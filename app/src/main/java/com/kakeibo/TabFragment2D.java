...
public class TabFragment2D extends Fragment {
    ...
    class ChildClickListener implements ExpandableListView.OnChildClickListener {
        ...
        public boolean onChildClick(ExpandableListView parent, View view, int groupPosition, int childPosition, long id) {
            ...
            String categoryText = getString(R.string.category_colon) + MainActivity.sCategory[item.getCategoryCode()];
    ...
    public void loadItemsOrderByDate() {
        ...
        if (c!=null && c.moveToFirst()) {
            ...
            do {
                ...
                _stringBuilder.append(",");
                _stringBuilder.append(MainActivity.sCategory[item.getCategoryCode()]);
                _stringBuilder.append(",");
        ...
        UtilFiles.writeToFile(CreateFileInFolderActivity.TMP_FILE_ORDER_DATE, _stringBuilder.toString(), _activity, Context.MODE_PRIVATE);
        _stringBuilder.setLength(0);
