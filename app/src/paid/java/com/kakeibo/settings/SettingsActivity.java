...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static final String PREF_KEY_CURRENCY_CODE = "pref_key_currency_codes";
    public static final String PREF_KEY_CURRENCY_INDEX = "pref_key_currency_index";
...
//        loadHeadersFromResource(R.xml.pref_headers, target);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(PREF_KEY_CURRENCY_CODE));

            final ListPreference listPreference = (ListPreference) findPreference(PREF_KEY_CURRENCY_CODE);
        ...
        protected void setListPreferenceData(ListPreference lp) {
            ArrayList<String> arrCodes = UtilFiles.getFileValues(MainActivity.FILE_CURRENCY, getActivity());

            CharSequence[] entries;
            CharSequence[] entryValues;
            if (arrCodes != null) {
                entries = new CharSequence[arrCodes.size()];
                entryValues = new CharSequence[arrCodes.size()];
                for (int i = 0; i < entries.length; ++i) {
                    entryValues[i] = ""+i;
                }
            } else {
                entries = getResources().getStringArray(R.array.pref_list_fraction_digits);
                entryValues = getResources().getStringArray(R.array.pref_list_fraction_digits_values);
            }

            lp.setEntries(entries);
            lp.setDefaultValue(MainActivity.intCurrencyIndex);
