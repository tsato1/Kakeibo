...
//        mDataSource.insertItemStatus(ITEM_STATUS_1);
//
//        //The user can be retrieved
//        try {
//            List<ItemStatus> dbItemStatuses = LiveDataTestUtil.getOrAwaitValue(mDataSource.getAll());
//
...
//        mDataSource.insertItemStatus(updatedItemStatus);
//
...
//                "1999-09-09",
//                "2010-04-22");
//        mDataSource.insertItemStatus(upsertedItemStatus);
//
//        //The retrieved user has the updated username
//        try {
//            List<ItemStatus> dbItemStatuses = LiveDataTestUtil.getOrAwaitValue(mDataSource.getAllItemStatus());
