...
////    }
//
//    public static void insertCategoryDspStatus(CategoryDsp categoryDsp, SqliteTestDbOpenHelper helper) {
//        SQLiteDatabase db = helper.getWritableDatabase();
//        ContentValues values = new ContentValues();
//        values.put(CategoryDspDBAdapter.COL_ID, categoryDsp.getId());
//        values.put(CategoryDspDBAdapter.COL_CODE, categoryDsp.getCode());
//        values.put(CategoryDspDBAdapter.COL_LOCATION, categoryDsp.getLocation());
