...
public class CurrencyUtilDateTest {
    @Test
    public void testGetBDAmount_fraction_2() {
        BigDecimal actual = UtilDate.getBDAmount(2018, 2);
    ...
    public void testGetBDAmount_fraction_1() {
        BigDecimal actual = UtilDate.getBDAmount(920, 1);
    ...
    public void testGetBDAmount_fraction_0() {
        BigDecimal actual = UtilDate.getBDAmount(920, 0);
    ...
    public void testGetIntAmount_fraction_3() {
        int actual = UtilDate.getIntAmount(BigDecimal.valueOf(150.200), 3);
        int expected = 150200;
        assertEquals("function failed", expected, actual);
    }
    ...
    public void testGetIntAmount_fraction_2() {
        int actual = UtilDate.getIntAmount(BigDecimal.valueOf(150.20), 2);
        int expected = 15020;
        assertEquals("function failed", expected, actual);
    }
    ...
    public void testGetIntAmount_fraction_1() {
        int actual = UtilDate.getIntAmount(BigDecimal.valueOf(150.0), 1);
        int expected = 1500;
        assertEquals("function failed", expected, actual);
    }
    ...
    public void testGetIntAmount() {
        int actual = UtilDate.getIntAmount(BigDecimal.valueOf(150), 0);
        int expected = 150;
        assertEquals("function failed", expected, actual);
    }
}